...
-- Dumping data for table CRMOnline_Pro.BH_CoHoiBanHang: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.BH_LoaiSanPham: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.BH_SanPham: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.HT_ChucVu: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.HT_PhongBan: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.HT_Role: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.HT_ThongTinNhanSu: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.HT_User: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.KH_DiaChi: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.KH_HoatDong: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.KH_KhachHang: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.KH_Lead: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.KH_LoaiKhachHang: ~0 rows (approximately)
...
-- Dumping data for table CRMOnline_Pro.KH_TinhTrangKhachHang: ~0 rows (approximately)

-- Dumping structure for table CRMOnline_Pro.Kho_TheKho
CREATE TABLE IF NOT EXISTS `Kho_TheKho` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `SanPham_Id` int unsigned NOT NULL,
  `MaChungTu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'Mã hóa đơn bán, phiếu nhập kho, v.v.',
...
-- Dumping data for table CRMOnline_Pro.Kho_TheKho: ~0 rows (approximately)
